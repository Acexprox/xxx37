  ...
  return (
    ...
    >
        ...
        {[
          ...
          <span
            ...
            style={{
              ...
              boxShadow: `
                0 0 15px rgba(214, 167, 86, 0.70),
                0 0 25px rgba(214, 167, 86, 0.50),
                0 0 35px rgba(214, 167, 86, 0.35),
                0 0 45px rgba(214, 167, 86, 0.25),
                0 0 55px rgba(180, 83, 9, 0.20),
      ...
      <div
        ...
        style={{ width: '3.5px', opacity: 0.98 }}
      >
      ...
      <div className="relative z-10 grid grid-cols-[1fr_1.05fr] gap-0 px-6 mt-4" dir="rtl">
        ...
        >
          ...
          >
            <div className="text-[13px] font-extrabold" style={{ color: "#3F2D17" }}>
              فئات متعددة
            </div>
            <div className="text-[12px] mt-0.5 leading-relaxed font-semibold" style={{ color: "#6B4E2E" }}>
      ...
      <div className="relative z-10 px-6 mt-3" dir="rtl">
        <div
          ...
          style={{
            background: `
              radial-gradient(circle at 50% 0%, rgba(255, 248, 237, 0.60) 0%, transparent 50%),
              linear-gradient(180deg, 
                rgba(214, 167, 86, 0.22) 0%, 
                rgba(214, 167, 86, 0.16) 50%,
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.background = `
              radial-gradient(circle at 50% 0%, rgba(255, 248, 237, 0.75) 0%, transparent 50%),
              linear-gradient(180deg, 
                rgba(214, 167, 86, 0.30) 0%, 
                rgba(214, 167, 86, 0.22) 50%,
      ...
      >
        ...
        >
          <motion.span
            ...
            whileHover={{
              boxShadow: [
                "0 12px 24px rgba(0, 0, 0, 0.14), 0 8px 16px rgba(0, 0, 0, 0.12), 0 4px 8px rgba(0, 0, 0, 0.10), 0 2px 4px rgba(0, 0, 0, 0.08), 0 1px 2px rgba(124, 45, 18, 0.06), inset 0 1px 0 rgba(255, 255, 255, 0.95), inset 0 -1px 0 rgba(214, 167, 86, 0.08)",
                "0 18px 38px rgba(37, 99, 235, 0.20), 0 12px 28px rgba(37, 99, 235, 0.16), 0 8px 18px rgba(37, 99, 235, 0.14), 0 4px 10px rgba(37, 99, 235, 0.12), 0 0 0 3px rgba(37, 99, 235, 0.25), inset 0 1px 0 rgba(255, 255, 255, 0.95), inset 0 0 30px rgba(37, 99, 235, 0.10)"
              ],
              y: -4,
              scale: 1.08,
